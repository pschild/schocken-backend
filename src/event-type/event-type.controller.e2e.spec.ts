...
describe('EventTypeController e2e', () => {
  ...
  describe('create', () => {
    it.each([
      ...
      [{ description: RANDOM_STRING(64), context: EventTypeContext.GAME, hasComment: true, multiplicatorUnit: RANDOM_STRING(32), trigger: EventTypeTrigger.START_NEW_ROUND, penalty: { penaltyUnit: 'invalid' }}, 400, ['penalty.penaltyValue must not be less than 0', 'penalty.penaltyValue must be a number conforming to the specified constraints', 'penalty.penaltyUnit must be one of the following values: EURO, BEER_CRATE']],
      [{ description: RANDOM_STRING(64), context: EventTypeContext.GAME, hasComment: true, multiplicatorUnit: RANDOM_STRING(32), trigger: EventTypeTrigger.START_NEW_ROUND, penalty: { penaltyUnit: PenaltyUnit.EURO }}, 400, ['penalty.penaltyValue must not be less than 0', 'penalty.penaltyValue must be a number conforming to the specified constraints']],
